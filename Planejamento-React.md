...
- [ ] **DOCX/PDF via React**: criar relatório com quebras de linha, unidades de comprimento, condições especiais (standby, noturno) e rascunho retomado; confirmar o DOCX/PDF gerado.
...
- [ ] **Validação visual React**: percorrer as telas em desktop e mobile validando RDO, Gestor, Coordenador e Cliente.
...
- A versão React passa a ser a interface principal em produção.
