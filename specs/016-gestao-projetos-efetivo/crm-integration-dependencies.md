...
Os fatos comerciais são exibidos no FiltroAPP como sinais de consulta. O preenchimento da tela foi removido; a integração deverá guardar `source`, referência externa, data da fonte e data da última sincronização sem transformar ausência de sinal em pendência operacional.
...
| Proposta aceita/assinada | Direta | Estado, data, versão aceita e evidência | Mostrar a procedência como sinal de consulta |
| Pedido de compra recebido | Direta | Número, data, valor, arquivo ou endereço e situação | Mostrar como sinal de consulta; Comercial trata divergências no CRM |
| Contrato assinado | Direta | Número, versão, partes, data e evidência | Mostrar como sinal de consulta |
...
5. O detalhe de gestão não oferece preenchimento manual dos sinais comerciais; correções devem ocorrer na origem e chegar em nova sincronização.
...
- **Entrega 2 — Liberação comercial e documentos**: manter o modelo neutro de fatos comerciais e exibi-lo como consulta; o adaptador do CRM preencherá a estrutura.
...
- **Entrega 5 — Pronto para mobilizar**: a frente Comercial aparece como sinalização; as frentes operacionais e documentais continuam internas e determinam a prontidão.
