...
- Entrega 031 concluída: perguntas comuns de Sim/Não começam sem seleção; o contato inicial permanece pendente até a confirmação positiva; o D-30 define equipe por cargo e quantidade e equipamentos por categoria, com avisos de contratação, disponibilidade, calibração e manutenção calculados para a mobilização. A futura conferência de documentos e treinamentos pela Solides permanece identificada sem dados simulados.
