...
- Entrega 028 preparada, com implementação pendente: catálogo versionado de documentos do projeto, aceite por versão, requisitos documentais por etapa, integração com Assinaturas e projeção dos RDOs/relatórios existentes. A modelagem reserva origem e versionamento do futuro CRM sem incluir o conector.
- O fluxo funcional planejado de Handover a Encerrado está concluído. Depois da Entrega 028, os próximos incrementos passam a ser integrações progressivas com equipamentos, estoque/Omie e o futuro CRM, além das automações de alertas descritas na Entrega 2.
