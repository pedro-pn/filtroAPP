...
Este catálogo cobre os **149 modelos Prisma de negócio** existentes em `backend/prisma/schema.prisma` em 2026-09-17, excluindo os seis modelos da própria infraestrutura de credenciais de API. Ele responde quais dados podem ser avaliados para endpoint, quais exigem revisão reforçada e quais nunca devem ser expostos por tokens desta funcionalidade.
