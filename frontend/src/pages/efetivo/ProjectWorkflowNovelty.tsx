    ...
    const start = (attempt = 0) => {
      ...
      guide = driver({
        ...
        steps: [
          ...
          { element: '[data-project-workflow-board]', popover: { title: 'Prazos e gates visíveis', description: 'D-90, D-30, D-15, D-7 e D-1 são calculados pela mobilização. Abra um card para acompanhar as frentes e emitir ou revalidar a autorização.', side: 'top', align: 'center' } }
        ]
      });
      guide.drive();
    };
