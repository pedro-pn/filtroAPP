  ...
  const startTutorial = useCallback(() => {
    ...
    window.setTimeout(() => {
      ...
      const steps: DriveStep[] = [
        { element: '[data-efetivo-nav]', popover: { title: 'Sete áreas integradas', description: 'Visão geral, calendário, pessoas, evolução, simulações, produtividade e administração compartilham a mesma base.', side: 'right', align: 'start' } },
        ...
        { element: '[data-efetivo-kanban]', popover: { title: 'Evolução acessível', description: 'As missões vêm dos projetos cadastrados: abra os cards destacados para completar cronologia, responsável e selecionar colaboradores pelo nome ou cargo. Cada etapa tem sua cor. Arraste o card por qualquer área — no celular, segure para pegar — ou use o seletor de etapa; cancelar restaura a ordem anterior.', side: 'top', align: 'start', onNextClick: navigateNext('disponibilidade') } },
