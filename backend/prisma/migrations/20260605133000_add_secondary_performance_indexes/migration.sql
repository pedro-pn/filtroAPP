CREATE INDEX IF NOT EXISTS "EpiRecord_collaboratorId_lendDate_createdAt_idx"
ON "EpiRecord"("collaboratorId", "lendDate", "createdAt");

CREATE INDEX IF NOT EXISTS "Romaneio_projectId_romaneioDate_createdAt_idx"
ON "Romaneio"("projectId", "romaneioDate", "createdAt");

CREATE INDEX IF NOT EXISTS "SatisfactionSurvey_sentAt_idx"
