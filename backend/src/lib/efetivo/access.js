...
export const EFETIVO_ACCESS_ROLES = [
  'efetivo:manager',
  'efetivo:viewer',
  'efetivo:commercial',
  'efetivo:operations',
...
export function canEditEfetivoChecklistArea(user, areaRoles = []) {
  return Boolean(user) && areaRoles.length > 0 && hasModuleRole(user, areaRoles);
}
