...
export const API_DATA_DOMAINS = Object.freeze([
  ...
  domain({
    ...
    models: [
      ...
      ...modelEntries(['EfetivoAuditEvent', 'ProjectWorkflow', 'ProjectWorkflowChecklist', 'ProjectWorkflowCriticalAnswer', 'ProjectWorkflowIssue', 'ProjectWorkflowCommercialFact', 'ProjectWorkflowEvent', 'ProjectWorkflowPostJob', 'ProjectWorkflowMeasurement'], 'RESERVED')
    ],
