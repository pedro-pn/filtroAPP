...
const rawEnvSchema = z.object({
  ...
  DATABASE_CONNECTION_LIMIT: integerWithDefault('DATABASE_CONNECTION_LIMIT', 10, { min: 1, max: 50 }),
  DATABASE_CONNECT_TIMEOUT_MS: integerWithDefault('DATABASE_CONNECT_TIMEOUT_MS', 5000, { min: 100, max: 60000 }),
  DATABASE_IDLE_TIMEOUT_MS: integerWithDefault('DATABASE_IDLE_TIMEOUT_MS', 30000, { min: 1000, max: 600000 }),
  DATABASE_STATEMENT_TIMEOUT_MS: integerWithDefault('DATABASE_STATEMENT_TIMEOUT_MS', 30000, { min: 1000, max: 300000 }),
  DATABASE_LOCK_TIMEOUT_MS: integerWithDefault('DATABASE_LOCK_TIMEOUT_MS', 5000, { min: 100, max: 60000 }),
  DATABASE_IDLE_TRANSACTION_TIMEOUT_MS: integerWithDefault('DATABASE_IDLE_TRANSACTION_TIMEOUT_MS', 30000, { min: 1000, max: 600000 }),
  ...
  ASSINATURAS_PREVIEW_CONCURRENCY: integerWithDefault('ASSINATURAS_PREVIEW_CONCURRENCY', 1, { min: 1, max: 4 }),
  DATA_RETENTION_JOB_ENABLED: booleanWithDefault('DATA_RETENTION_JOB_ENABLED', false),
  BACKGROUND_JOBS_IN_API: booleanWithDefault('BACKGROUND_JOBS_IN_API', true),
...
export function loadEnv(source = process.env) {
  ...
  return {
    ...
    databaseIdleTimeoutMs: raw.DATABASE_IDLE_TIMEOUT_MS,
    databaseStatementTimeoutMs: raw.DATABASE_STATEMENT_TIMEOUT_MS,
    databaseLockTimeoutMs: raw.DATABASE_LOCK_TIMEOUT_MS,
    databaseIdleTransactionTimeoutMs: raw.DATABASE_IDLE_TRANSACTION_TIMEOUT_MS,
    ...
    projectDocumentMaxMb: raw.PROJECT_DOCUMENT_MAX_MB,
    ...
    assinaturasPreviewConcurrency: raw.ASSINATURAS_PREVIEW_CONCURRENCY,
    dataRetentionJobEnabled: raw.DATA_RETENTION_JOB_ENABLED,
    backgroundJobsInApi: raw.BACKGROUND_JOBS_IN_API,
